// Dafny program findmax.dfy compiled into C#
...
// Command Line Options: d:\ece653\h843zhan\a3\dafny\pancakesort\findmax.dfy /verifyAllModules /spillTargetCode:1 /compile:3 /out:bin\findmax
// findmax.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger findMax(BigInteger[] a, BigInteger n)
    {
      ...
      BigInteger _0_mi = BigInteger.Zero;
      BigInteger _1_i = BigInteger.Zero;
      _0_mi = BigInteger.Zero;
      _1_i = BigInteger.Zero;
      while ((_1_i) < (n)) {
        if (((a)[(int)(_1_i)]) > ((a)[(int)(_0_mi)])) {
          _0_mi = _1_i;
        }
