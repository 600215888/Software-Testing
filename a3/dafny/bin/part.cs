// Dafny program part.dfy compiled into C#
...
// Command Line Options: d:\ece653\h843zhan\a3\dafny\quicksort\part.dfy /verifyAllModules /spillTargetCode:1 /compile:3 /out:bin\part
// part.dfy
...
method partition(a: array<int>, l: nat, u: nat)
    returns (pivot: int)
  requires a != null
  ...
  decreases a, l, u
{
  ...
  while j < u
    invariant a[u] == pv
    invariant l - 1 <= i < j <= u
    invariant forall k: int :: l <= k <= i ==> a[k] <= a[u]
    invariant forall k: int :: i < k < j ==> a[k] > a[u]
    invariant forall k: int :: j < k < u && k != pi ==> a[k] == old(a[k])
    invariant forall k: int :: j < k < u && k == pi ==> a[u] == old(a[k])
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger choose(BigInteger l, BigInteger u)
    {
      BigInteger rv = BigInteger.Zero;
      return rv;
    }
    /* Compilation error: an assume statement cannot be compiled */
    public static BigInteger partition(BigInteger[] a, BigInteger l, BigInteger u)
    {
      BigInteger pivot = BigInteger.Zero;
      BigInteger _0_pi;
      BigInteger _out0;
      _out0 = __default.choose(l, u);
      _0_pi = _out0;
      BigInteger _1_pv;
      _1_pv = (a)[(int)(_0_pi)];
      (a)[(int)((_0_pi))] = (a)[(int)(u)];
      ...
      while ((_3_j) < (u)) {
        if (((a)[(int)(_3_j)]) <= (_1_pv)) {
          ...
          BigInteger _4_t;
          _4_t = (a)[(int)(_2_i)];
          (a)[(int)((_2_i))] = (a)[(int)(_3_j)];
          (a)[(int)((_3_j))] = _4_t;
        }
        _3_j = (_3_j) + (BigInteger.One);
      }
      pivot = (_2_i) + (BigInteger.One);
      BigInteger _5_t;
      _5_t = (a)[(int)(pivot)];
      (a)[(int)((pivot))] = (a)[(int)(u)];
      (a)[(int)((u))] = _5_t;
