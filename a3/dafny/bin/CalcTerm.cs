// Dafny program CalcTerm.dfy compiled into C#
...
// Command Line Options: d:\ece653\h843zhan\a3\dafny\CalcTerm.dfy /verifyAllModules /compile:1 /spillTargetCode:1 /out:bin\CalcTerm
// CalcTerm.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger abs(BigInteger m) {
      if ((m).Sign == 1) {
        return m;
      } else {
        return (BigInteger.Zero) - (m);
      }
    }
    public static BigInteger CalcTerm(BigInteger m, BigInteger n)
    {
      BigInteger res = BigInteger.Zero;
      BigInteger _0_m1;
      _0_m1 = __default.abs(m);
      BigInteger _1_n1;
      _1_n1 = n;
      res = BigInteger.Zero;
      while ((_0_m1).Sign != 0) {
        res = (res) + (new BigInteger(5));
        _0_m1 = (_0_m1) - (BigInteger.One);
      }
      if ((m).Sign == -1) {
        res = (BigInteger.Zero) - (res);
      }
      while ((_1_n1).Sign != 0) {
        res = (res) - (new BigInteger(3));
        _1_n1 = (_1_n1) - (BigInteger.One);
      }
      return res;
    }
  }
