// Dafny program PancakeSort.dfy compiled into C#
...
// Command Line Options: d:\ece653\h843zhan\a3\dafny\pancakesort\PancakeSort.dfy /verifyAllModules /spillTargetCode:1 /compile:3 /out:bin\PancakeSort
// PancakeSort.dfy
  ...
  decreases a
{
  ...
  while curr_size > 1
    ...
    invariant forall i: int, j: int :: 0 <= i < curr_size <= j < a.Length ==> a[i] <= a[j]
    invariant forall i: int, j: int :: curr_size <= i <= j < a.Length ==> a[i] <= a[j]
    decreases curr_size
  {
...
method flip(a: array<int>, num: int)
  ...
  modifies a
  ensures forall i: int :: 0 <= i <= num ==> a[i] == old(a[num - i])
  ensures forall i: int :: num < i < a.Length ==> a[i] == old(a[i])
  decreases a, num
{
  var tmp: int;
  var i := 0;
  ...
  while i < j
    ...
    invariant forall k: int :: 0 <= k < i ==> a[k] == old(a[num - k]) && a[num - k] == old(a[k])
    invariant forall k: int :: num < k < a.Length ==> a[k] == old(a[k])
...
method findMax(a: array<int>, n: int) returns (r: int)
  ...
  ensures 0 <= r < n
  ensures forall i: int :: 0 <= i < n ==> a[i] <= a[r]
  decreases a, n
{
  var mi;
  var i;
  ...
  while i < n
    ...
    invariant forall j: int :: 0 <= j < i ==> a[mi] >= a[j]
    decreases n - i
  {
    if a[i] > a[mi] {
      mi := i;
...
namespace _module {
  ...
  public partial class __default {
    public static void pancakeSort(BigInteger[] a)
    {
      BigInteger _0_curr__size;
      _0_curr__size = new BigInteger((a).Length);
      while ((_0_curr__size) > (BigInteger.One)) {
        BigInteger _1_mi;
        BigInteger _out0;
        _out0 = __default.findMax(a, _0_curr__size);
        _1_mi = _out0;
        if ((_1_mi) != ((_0_curr__size) - (BigInteger.One))) {
          __default.flip(a, _1_mi);
          __default.flip(a, (_0_curr__size) - (BigInteger.One));
        }
        _0_curr__size = (_0_curr__size) - (BigInteger.One);
      }
    }
    public static void flip(BigInteger[] a, BigInteger num)
    {
      BigInteger _2_tmp = BigInteger.Zero;
      BigInteger _3_i;
    ...
    public static BigInteger findMax(BigInteger[] a, BigInteger n)
    {
      ...
      BigInteger _5_mi = BigInteger.Zero;
      BigInteger _6_i = BigInteger.Zero;
      _5_mi = BigInteger.Zero;
      _6_i = BigInteger.Zero;
      while ((_6_i) < (n)) {
        if (((a)[(int)(_6_i)]) > ((a)[(int)(_5_mi)])) {
          _5_mi = _6_i;
        }
